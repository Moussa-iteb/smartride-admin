...
export class TripDetailComponent implements OnInit {
  ...
  // ← mapOptions هنا كـ property مش داخل دالة
  ...
  console.log('USER DATA:', JSON.stringify(tu.user, null, 2));
  ...
  buildMap(tu: any) {
    ...
    console.log('nombre:', points.length);
    console.log('data:', JSON.stringify(points, null, 2));
